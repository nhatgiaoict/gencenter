...
<%@ Register Src="~/Home/uc_header2.ascx" TagName="hd" TagPrefix="uc1" %>
        ...
        <div class="shell">
            <div class="range range-xs-center">
                <div class="cell-md-10 cell-lg-8">
                    <div class="range range-xs-center">
                        <asp:Repeater ID="rptN" runat="server">
                            <ItemTemplate>
                                <div class="cell-sm-6 <%# Container.ItemIndex > 1 ? "offset-top-50 offset-sm-top-60": "" %>">
                ...
                <div class="cell-sm-10 cell-md-8 cell-lg-4 offset-top-66 offset-md-top-90 offset-lg-top-0">
                    <uc1:uc_menunew runat="server" ID="uc_menunew1" />
                </div>
            </div>
        </div>
    </section>
