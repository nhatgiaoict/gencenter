<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Slideshow.aspx.cs" Inherits="Slideshow_Slideshow" %>
...
<%@ Register src="Slideshow_con.ascx" tagname="Slideshow_con" tagprefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
							    <uc5:Slideshow_con ID="Slideshow_con1" runat="server" />
							</td>
						</tr>
					</table>
