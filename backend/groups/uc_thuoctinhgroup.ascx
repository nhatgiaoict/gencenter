<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_thuoctinhgroup.ascx.cs" Inherits="groups_uc_thuoctinhgroup" %>
	...
	<tbody>
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#aaaeb5">
			<tr bgcolor="#9dbae9" height="30px">
				<td align="center" width="5%"><strong>STT</strong>
				</td>
				<td width="20%" style="padding-left:10px"><strong>Tên nhóm thuộc tính</strong></td>
				<td align="center" width="10%"><strong>Giá trị</strong></td>
			...
			<asp:Repeater ID="rptList" runat="server" onitemdatabound="rptList_ItemDataBound" 
                        onitemcreated="rptList_ItemCreated">
			<ItemTemplate>
			<tr height="25px" class="item" id="trItems" runat="server">
				<td align="center" width="5%"><asp:Literal ID="ltlID" Runat="server"  Visible="false"></asp:Literal>
				<%#Eval("row_index")%></td>
				<td width="20%" style="padding-left:10px"><%#Eval("title")%></td>
				<td align="center" width="10%"><asp:LinkButton ID="ltllAddThuoctin" Text="Thêm giá trị" runat="server"></asp:LinkButton></td>
		...
		<td><asp:Button ID="btnThem" runat="server" Text="Thêm mới" 
                onclick="btnThem_Click" />&nbsp;&nbsp;<asp:Button ID="btnOk" runat="server" 
                Text="Cập nhật" onclick="btnOk_Click" /></td>
		</tr>
</table>