<%@ Page Language="C#" AutoEventWireup="true" CodeFile="thuoctinhgroup.aspx.cs" Inherits="groups_thuoctinhgroup" %>
<%@ Register Src="~/groups/uc_thuoctinhgroup.ascx" TagName="uc_thuoctinhgroup" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
							    <uc5:uc_thuoctinhgroup ID="uc_thuoctinhgroup1" runat="server" />
							</td>
						</tr>
					</table>
