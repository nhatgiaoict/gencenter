<%@ Page Language="C#" AutoEventWireup="true" CodeFile="changepwd.aspx.cs" Inherits="_profile_changepwd" %>

<%@ Register Src="changepwd.ascx" TagName="changepwd" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
							 <uc5:changepwd ID="Changepwd1" runat="server" />
							</td>
						</tr>
					</table>
