<%@ Page Language="C#" AutoEventWireup="true" CodeFile="profile.aspx.cs" Inherits="_profile_profile" %>
...
<%@ Register Src="profile.ascx" TagName="profile" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
							 <uc5:profile ID="Profile1" runat="server" />
							</td>
						</tr>
					</table>
