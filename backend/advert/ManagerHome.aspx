<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerHome.aspx.cs" Inherits="advert_ManagerHome" %>
<%@ Register Src="~/advert/ManagerHomeCon.ascx" TagName="managerhomecon" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td align="center">
							<uc5:managerhomecon ID="ManagerHome" runat="server" />
                                </td>
						</tr>
					</table>
