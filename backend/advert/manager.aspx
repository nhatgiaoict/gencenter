<%@ Page Language="C#" AutoEventWireup="true" CodeFile="manager.aspx.cs" Inherits="advert_manager" %>

<%@ Register Src="manager_con.ascx" TagName="manager_con" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td align="center">
                                <uc5:manager_con ID="Manager_con1" runat="server" />
							</td>
						</tr>
					</table>
