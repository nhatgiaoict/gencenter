<%@ Page Language="C#" AutoEventWireup="true" CodeFile="update.aspx.cs" Inherits="advert_update" ValidateRequest="false" %>

<%@ Register Src="update_con.ascx" TagName="update_con" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td align="center">
                                <uc5:update_con ID="Update_con1" runat="server" />                               
							</td>
						</tr>
					</table>
				</td>
