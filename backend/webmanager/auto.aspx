<%@ Page Language="C#" AutoEventWireup="true" CodeFile="auto.aspx.cs" Inherits="webmanager_auto" %>

<%@ Register Src="auto_con.ascx" TagName="auto_con" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td align="center">                               
                                <uc5:auto_con ID="Auto_con1" runat="server" />
