<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerYhaoo.aspx.cs" Inherits="YahooHelp_ManagerYhaoo" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Src="~/YahooHelp/Yhaoo_con.ascx" TagName="YahooCon" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
							    <uc5:YahooCon ID="yhooCon" runat="server" />
							</td>
						</tr>
					</table>
