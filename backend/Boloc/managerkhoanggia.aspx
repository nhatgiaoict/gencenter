<%@ Page Language="C#" AutoEventWireup="true" CodeFile="managerkhoanggia.aspx.cs" Inherits="Boloc_managerkhoanggia" %>

<%@ Register Src="~/Boloc/uc_khoanggia.ascx" TagName="uc_khoanggia" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td align="center"><uc5:uc_khoanggia ID="uc_khoanggia1" runat="server" /></td>
						</tr>
					</table>
