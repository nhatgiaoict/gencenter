<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Managernhasanxuat.aspx.cs" Inherits="Boloc_Managernhasanxuat" %>


<%@ Register Src="~/Boloc/uc_managernsx.ascx" TagName="uc_managernsx" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td align="center"><uc5:uc_managernsx ID="uc_managernsx1" runat="server" /></td>
						</tr>
					</table>
