<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicProductTieubieu.aspx.cs" Inherits="publish_PublicProductTieubieu" %>
...
<%@ Register src="~/publish/uc_productieubieu.ascx" tagname="Moinhat_home_con" tagprefix="uc5" %>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table1">
            ...
            <tr>
                ...
                <td width="95%" valign="top" style="padding-top: 10px" align="center">
                     <uc5:Moinhat_home_con ID="Moinhat_home_con1" runat="server" />
                 </td>
            </tr>
            <tr>
                <td colspan="2">
