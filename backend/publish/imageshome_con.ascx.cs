...
public partial class publish_imageshome_con : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            rptNews.DataSource = objImage.Searching(cPage, 15, out TotalRecords, out TotalPages);
            rptNews.DataBind();
    ...
    protected void BtAdd_Click(object sender, EventArgs e)
    {
        ...
        ImageLogo objImage = new ImageLogo();
        objImage.Insert(sName, sFilename, fwidht,fheight);
    ...
    protected void rptNews_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        if (e.Item.ItemIndex != -1 && e.Item.ItemType != ListItemType.Separator)
        {
            ...
            if (dr != null)
            {
                ...
                sUrl = new UssUrl(Globals.URLCurrent + "DetailBaner.aspx");
