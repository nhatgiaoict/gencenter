...
public partial class publish_uc_productieubieu : System.Web.UI.UserControl
{
    ...
    protected void GetData()
    {
        ...
        rptGroup.DataSource = publish.GetPublish_Noibat();
        rptGroup.DataBind();
        ...
        rptFree.DataSource = publish.GetNotInPublish_Noibat(keyword, groupid, cPage, 25, out TotalRecords, out TotalPages);
        rptFree.DataBind();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        foreach (RepeaterItem rptItem in rptGroup.Items)
        {
            ...
            publish.UpdateIndex_NoiBat(id, Convert.ToInt32(txtIdx.Text.ToString()));
        }
        GetData();
    ...
    private void lbtDelete_Click(object sender, System.EventArgs e)
    {
        ...
        if (lbtDelete.CommandArgument != String.Empty)
        {
            ...
            publish = new Publish(groupid);
            publish.RemoveFromPublish_NoiBat(id);
            GetData();
            //Response.Redirect(Globals.UrlRoot + "temp.aspx?url=" + Request.Url);
        }
    }
    private void lbtSelect_Click(object sender, System.EventArgs e)
    {
        ...
        if (lbtSelect1.CommandArgument != String.Empty)
        {
            ...
            publish = new Publish(groupid);
            publish.AddToPublish_NoiBat(id);
            GetData();
            //Response.Redirect(Globals.UrlRoot + "temp.aspx?url=" + Request.Url);
        }
    }
