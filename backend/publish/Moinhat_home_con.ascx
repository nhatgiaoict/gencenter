<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Moinhat_home_con.ascx.cs" Inherits="publish_Moinhat_home_con" %>
...
<table cellspacing="0" cellpadding="0" width="95%" border="0">
    <tr class="Form_Header">
        <td align="left" colspan="2" height="22" style="padding-left: 5px" background="<%=UrlImages%>BodyTop.gif">
            <asp:Image ID="imgIconHeader" BorderWidth="0" runat="server"></asp:Image>&nbsp;Tổ chức Team</td>
    </tr>
    <tr>
