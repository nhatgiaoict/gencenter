<%@ Page Language="C#" AutoEventWireup="true" CodeFile="group.aspx.cs" Inherits="publish_group" %>
<%@ Register Src="listgroup_con.ascx" TagName="listgroup_con" TagPrefix="uc6" %>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table1">
            ...
            <tr>
                ...
                <td width="95%" valign="top" style="padding-top: 10px" align="center">
                    <uc6:listgroup_con id="Listgroup_con1" runat="server">
                    </uc6:listgroup_con></td>
            </tr>
            <tr>
                <td colspan="2">
