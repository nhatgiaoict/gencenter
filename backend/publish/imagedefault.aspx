<%@ Page Language="C#" AutoEventWireup="true" CodeFile="imagedefault.aspx.cs" Inherits="publish_imagedefault" %>
...
<%@ Register Src="../controls/style.ascx" TagName="style" TagPrefix="uc1" %>
 <%@ Register src="imagedefault_con.ascx" tagname="imagedefault_con" tagprefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
							    <uc5:imagedefault_con ID="imagedefault_con1" runat="server" />
							</td>
						</tr>
					</table>
