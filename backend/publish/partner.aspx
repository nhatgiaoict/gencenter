<%@ Page Language="C#" AutoEventWireup="true" CodeFile="partner.aspx.cs" Inherits="publish_partner" %>

<%@ Register Src="partner_con.ascx" TagName="partner_con" TagPrefix="uc5" %>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table1">
            ...
            <tr>
                ...
                <td width="95%" valign="top" style="padding-top: 10px" align="center">
                    <uc5:partner_con ID="Partner_con1" runat="server" />
