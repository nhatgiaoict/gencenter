<%@ Control Language="C#" AutoEventWireup="true" CodeFile="uc_productieubieu.ascx.cs" Inherits="publish_uc_productieubieu" %>
<%@ Register TagPrefix="cc1" Namespace="uss.pagelist" Assembly="uss.pagelist" %>
<table cellspacing="0" cellpadding="0" width="95%" border="0">
    <tr class="Form_Header">
        <td align="left" colspan="2" height="22" style="padding-left: 5px" background="/data/images/BodyTop.gif">
            <img style="border-width:0px;" src="/data/images/icon_menu1.gif">&nbsp;Tổ chức tin giới thiệu</td>
    </tr>
    <tr>
