<%@ Page Language="C#" AutoEventWireup="true" CodeFile="advert.aspx.cs" Inherits="publish_advert" %>
<%@ Register Src="advert_con.ascx" TagName="advert_con" TagPrefix="uc5" %>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table1">
            ...
            <tr>
                ...
                <td width="95%" valign="top" style="padding-top: 10px" align="center">
                    <uc5:advert_con ID="Advert_con1" runat="server" />
