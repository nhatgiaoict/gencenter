...
using uss.utils;
public partial class publish_Moinhat_home_con : System.Web.UI.UserControl
{
    ...
    protected void GetData()
    {
        ...
        rptGroup.DataSource = publish.GetPublish_MoiNhatNews();
        rptGroup.DataBind();
        ...
        rptFree.DataSource = publish.GetNotInPublish_MoiNhatNews(keyword, groupid, cPage, 25, out TotalRecords, out TotalPages);
        rptFree.DataBind();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        foreach (RepeaterItem rptItem in rptGroup.Items)
        {
            ...
            publish.UpdateIndex_MoiNhatNews(id, Convert.ToInt32(txtIdx.Text.ToString()));
        }
        GetData();
    ...
    private void lbtDelete_Click(object sender, System.EventArgs e)
    {
        ...
        if (lbtDelete.CommandArgument != String.Empty)
        {
            ...
            publish = new Publish(groupid);
            publish.RemoveFromPublish_MoiNhatNews(id);
            GetData();
            //Response.Redirect(Globals.UrlRoot + "temp.aspx?url=" + Request.Url);
        }
    }
    private void lbtSelect_Click(object sender, System.EventArgs e)
    {
        ...
        if (lbtSelect1.CommandArgument != String.Empty)
        {
            ...
            publish = new Publish(groupid);
            publish.AddToPublish_MoiNhatNews(id);
            GetData();
            //Response.Redirect(Globals.UrlRoot + "temp.aspx?url=" + Request.Url);
        }
    }
