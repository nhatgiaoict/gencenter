<%@ Control Language="C#" AutoEventWireup="true" CodeFile="partner_con.ascx.cs" Inherits="publish_partner_con" %>
            ...
            <table cellspacing="5" cellpadding="0" width="95%" align="center" border="0">
                <tbody>
                    <tr>
                        <td>
                            <strong>
                                <asp:Literal ID="ltlHeader1" runat="server" Text="Danh sách Doi tac tự do"></asp:Literal></strong></td>
                    </tr>
                    <tr>
                        <td>
