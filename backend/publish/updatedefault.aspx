<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updatedefault.aspx.cs" Inherits="publish_updatedefault" %>
...
<%@ Register Src="../controls/style.ascx" TagName="style" TagPrefix="uc1" %>
 <%@ Register src="updatedefault_con.ascx" tagname="updatedefault_con" tagprefix="uc5" %>
            ...
            <tr>
                ...
                <td width="80%" valign="top" style="padding-top: 10px" align="center">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
                        <tr>
                            <td>
                                <uc5:updatedefault_con ID="updatedefault_con1" runat="server" />
                        </tr>
                    </table>
                </td>
            </tr>
