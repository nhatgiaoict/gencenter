<%@ Page Language="C#" AutoEventWireup="true" CodeFile="images_home.aspx.cs" Inherits="publish_images_home" %>

<%@ Register Src="imageshome_con.ascx" TagName="imageshome_con" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
                                <uc5:imageshome_con ID="Imageshome_con1" runat="server" />
