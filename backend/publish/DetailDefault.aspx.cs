...
using uss.utils;
public partial class publish_DetailDefault : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!this.IsPostBack)
        {
            ...
            if (newsid == "" || newsid == string.Empty || newsid == null)
                Response.Redirect(Globals.URLCurrent + "imagedefault.aspx");
            DataRow dr = imgbaner.GetInfoStatusDefault(newsid);
            if (dr != null)
            {
