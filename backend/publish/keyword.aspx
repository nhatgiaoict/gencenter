<%@ Page Language="C#" AutoEventWireup="true" CodeFile="keyword.aspx.cs" Inherits="keyword_keyword" %>
...
<%@ Register Src="../controls/style.ascx" TagName="style" TagPrefix="uc1" %>
 <%@ Register src="keyword_con.ascx" tagname="keyword_con" tagprefix="uc5" %>
					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
							    ...
							    <uc5:keyword_con ID="keyword_con1" runat="server" />
