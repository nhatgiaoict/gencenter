<%@ Page Language="C#" AutoEventWireup="true" CodeFile="choduyet.aspx.cs" Inherits="_news_choduyet" %>

<%@ Register Src="choduyet.ascx" TagName="choduyet" TagPrefix="uc6" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td align="center">
							<uc6:choduyet ID="Choduyet1" runat="server" />
							</td>
						</tr>
					</table>
