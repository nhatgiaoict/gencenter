...
<table cellspacing="5" cellpadding="0" width="95%" align="center" border="0">
    ...
    <tr>
        ...
        <td align="left">
            <asp:TextBox ID="tbxTitle" runat="server" Width="450"></asp:TextBox></td>
        <td>&nbsp;</td>
    </tr>
    <tr>
        <td>Short Url</td>
        <td>
            <input id="txtShotlink" runat="server" style="width: 450px;" /></td>
    </tr>
    <tr>
        <td>Title Meta</td>
        <td>
            <asp:TextBox ID="txtTitleMeta" runat="server" Width="450"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Keyword Meta</td>
        <td>
            <asp:TextBox ID="txtkeyword" TextMode="MultiLine" runat="server" Height="50" Width="450"></asp:TextBox></td>
    </tr>
    <tr>
        <td>Description Meta</td>
        <td>
            <asp:TextBox ID="txtDescripton" TextMode="MultiLine" runat="server" Height="50" Width="450"></asp:TextBox></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    ...
    <tr>
        <td style="padding-left: 5px" align="left" colspan="3">
            <div style="clear: both; border-right: #0070b5 1px solid; padding-right: 5px; border-top: #0070b5 1px solid; padding-left: 5px; padding-bottom: 5px; overflow: auto; border-left: #0070b5 1px solid; padding-top: 5px; border-bottom: #0070b5 1px solid; width: 300px; height: 150px">
                ...
                <tr>
                    ...
                    <td style="padding-left: 10px">
                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            <tr>
                                <td>
                                    <asp:Image Width="200px" ID="imgLogo" runat="server" BorderWidth="0"></asp:Image></td>
                            </tr>
                            <tr>
                                <td>
                                    <input id="txtFileImages" runat="server" name="FilePath" type="text" size="70" />
                                    <img alt="Chọn ảnh minh họa" src="/data/images/folder.gif" onclick="BrowseServer();" />
                                </td>
                            </tr>
                            <tr>
                                <td height="10">&nbsp;</td>
    ...
    <tr>
        <td width="10%">
            <asp:Literal ID="ltlGhichu" runat="server" />&nbsp;:&nbsp;</td>
        <td align="left">
            <asp:TextBox ID="txtGhichu" Width="350px" Height="50px" TextMode="MultiLine" runat="server"></asp:TextBox></td>
        <td width="10%"></td>
    </tr>
    <!---End Noi dung--->
    <tr>
