<%@ Page Language="C#" AutoEventWireup="true" CodeFile="listvanban.aspx.cs" Inherits="_news_listvanban" %>

<%@ Register Src="~/news/listvanban.ascx" TagName="listbaiviet" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td align="center">
							<uc5:listbaiviet ID="Listbaiviet1" runat="server" />
							</td>
						</tr>
					</table>
