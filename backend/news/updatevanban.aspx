<%@ Page Language="C#" AutoEventWireup="true" CodeFile="updatevanban.aspx.cs" Inherits="_news_updatevanban" ValidateRequest="false"%>

<%@ Register Src="~/news/updatevanban.ascx" TagName="update" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
							<uc5:update ID="Update1" runat="server" />
							</td>
						</tr>
					</table>
