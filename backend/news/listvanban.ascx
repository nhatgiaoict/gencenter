<%@ Control Language="C#" AutoEventWireup="true" CodeFile="listvanban.ascx.cs" Inherits="news_listvanban" %>
    ...
    <tbody>
        <tr class="Form_Header" >
            <td align="left" height="22" background="/data/images/BodyTop.gif" style="padding-left: 5px">
                <img style="border-width:0px;" src="/data/images/icon_menu1.gif">&nbsp;Danh sách bài viết sản phẩm</td>
        </tr>
        <tr>
            <td>
                ...
                <asp:Repeater ID="rptNews" runat="server" OnItemCreated="rptNews_ItemCreated" OnItemDataBound="rptNews_ItemDataBound">
                    <HeaderTemplate>
                        <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#aaaeb5">
                            <tr bgcolor="#9dbae9" height="30px">
                                ...
                                <td style="padding-left: 10px"  align="left"><strong>Tên sản phẩm</strong></td>
                                <td align="center" width="90px" style="padding-left:5px"><strong>Hoàn thành</strong></td>
                                <td align="center" width="90px" style="padding-left:5px"><strong>Nổi bật</strong></td>
                                <td width="90px" style="padding-left:5px"><strong>Ngày đăng</strong></td>
                    ...
                    <ItemTemplate>
                        <tr class="item" id="trItems" runat="server" height="25px">
                            ...
                            <td style="width:80; padding-left:5px; text-align:center;"><asp:LinkButton ID="ltbHoanthanh" runat="server"></asp:LinkButton></td>
                            
                            <td align="center"><asp:LinkButton ID="ltbMoi" runat="server"></asp:LinkButton></td>
