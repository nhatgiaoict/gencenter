<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bientap.aspx.cs" Inherits="_news_bientap" %>

<%@ Register Src="bientap.ascx" TagName="bientap" TagPrefix="uc5" %>
			...
			<tr>
				...
				<td width="80%" valign="top" style="PADDING-TOP:10px" align="center">
					<table width="100%" cellpadding="0" cellspacing="0" border="0" id="Table2">
						<tr>
							<td>
							<uc5:bientap ID="Bientap1" runat="server" />
							</td>
						</tr>
					</table>
