<%@ Control Language="C#" AutoEventWireup="true" CodeFile="bientap.ascx.cs" Inherits="news_bientap" %>
					...
					<ItemTemplate>
						<tr class="item" id="trItems" runat="server" height="25px">
							...
							<td align="center"><asp:LinkButton ID="lbtSend" Runat="server">
									<img id="imgSend" runat="server" src="http://localhost/dat.bktt/images/icon_submit.gif"
