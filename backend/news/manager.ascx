<%@ Control Language="C#" AutoEventWireup="true" CodeFile="manager.ascx.cs" Inherits="news_manager" %>
...
<table cellSpacing="5" cellPadding="0" width="95%" align="center" border="0">
	<TBODY>
		<tr class="Form_Header">
			<td align="left" style="PADDING-LEFT: 5px" height="22" background="<%=UrlImages%>BodyTop.gif"><asp:image id="imgIconHeader" BorderWidth="0" Runat="server"></asp:image>&nbsp;<asp:literal id="ltlHeader" Runat="server" Text="Danh sách bài biên tập"></asp:literal></td>
		</tr>
		<tr>
			<td>
				<table cellSpacing="1" cellPadding="5" width="100%" bgColor="#e8edf6" border="0">
					...
					<tr bgColor="#ffffff">
						...
						<td style="PADDING-RIGHT: 20px"><asp:textbox id="txtKeyword" Runat="server"></asp:textbox></td>
						<td align="right"><asp:literal id="ltlStatus" Runat="server" Text="Trạng thái"></asp:literal></td>
						<td><asp:dropdownlist id="ddlStatus" runat="server"></asp:dropdownlist></td>
						<td style="PADDING-RIGHT: 20px" align="right"><asp:imagebutton id="imgBtn" runat="server" ImageUrl="http://localhost/dat.bktt/images/search_new.gif" OnClick="imgBtn_Click"></asp:imagebutton></td>
					</tr>
				</table>
			</td>
		</tr>
					...
					<HeaderTemplate>
						<table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#aaaeb5">
							<tr bgcolor="#9dbae9" height="30px">
								...
								<td align="left" style="width:150px; padding-left:10px"><strong><asp:Literal ID="ltlLastUpdateHeader" Runat="server" Text="Ngày cập nhật"></asp:Literal></strong></td>
								<td align="center" width="80px"><strong><asp:Literal ID="ltlStatusHeader" Runat="server" Text="Trạng thái"></asp:Literal></strong></td>
					...
					<ItemTemplate>
						<tr class="item" id="trItems" runat="server" height="25px">
							...
							<td align="left" style="padding-left:5px">
							     ...
							     (<asp:LinkButton ID="lbtDateStatus" Runat="server"></asp:LinkButton>)							     
							 </td>
							...
							<td align="center"><asp:LinkButton ID="lbtReturn" Runat="server">
									<img id="imgReturn" runat="server" src="http://localhost/dat.bktt/images/icon_return.gif"
