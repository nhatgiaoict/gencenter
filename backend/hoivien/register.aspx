<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register.aspx.cs" Inherits="hoivien_register" ValidateRequest="false" %>

<%@ Register Src="~/hoivien/register.ascx" TagName="register" TagPrefix="uc5" %>
