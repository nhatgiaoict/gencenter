<%@ Control Language="C#" AutoEventWireup="true" CodeFile="manager.ascx.cs" Inherits="uchoivien_manager" %>
...
<table cellspacing="5" cellpadding="0" width="95%" align="center" border="0">
    <tbody>
        <tr class="Form_Header" >
            <td align="left" height="22" background="/data/images/BodyTop.gif" style="padding-left: 5px">
                <img style="border-width:0px;" src="/data/images/icon_menu1.gif">&nbsp;Danh sách các hội viên</td>
        </tr>
        <tr>
            <td>
                <table cellspacing="1" cellpadding="5" width="100%" bgcolor="#e8edf6" border="0">
                    ...
                    <tr bgcolor="#ffffff">
                        <td style="padding-left: 20px" width="20%">Từ khoá</td>
                        <td style="padding-right: 20px" >
                            <asp:TextBox ID="txtKeyword" runat="server" Width="242px"></asp:TextBox>
                            </td>
                        <td align="right" style ="padding-right:50px; text-align:center;" ><asp:ImageButton ID="imgBtn" runat="server" ImageUrl="http://localhost/data/images/search_new.gif" OnClick="imgBtn_Click" style="margin-left: 0px">
                            </asp:ImageButton>&nbsp;</td>
                        <td>
                            </td>
                    ...
                    <HeaderTemplate>
                        <table width="100%" border="0" cellspacing="1" cellpadding="1" bgcolor="#aaaeb5">
                            <tr bgcolor="#9dbae9" height="30px">
                                <td>&nbsp;</td>
                                <td align="center" width="40px"><strong>STT</strong></td>
                                <td style="padding-left: 10px"  align="left"><strong>Tên hội viên</strong></td>
                                <td style="width:80; padding-left:5px; text-align:center;"><strong>Ngành nghề kinh doanh</strong></td>
                                <td width="90px" style="padding-left:5px"><strong>Ngày tạo</strong></td>
                                <td align="center" width="60px"><strong>Trạng thái</strong></td>
                                <td align="center" width="40px"><strong>Xem Log</strong></td>
                                <td align="center" width="40px"><strong>Sửa</strong></td>
                            </tr>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <tr class="item" id="trItems" runat="server" height="25px">
                            ...
                            <td align="center"><asp:TextBox ID="txtSTT" runat="server" Width="40"></asp:TextBox></td>
                            <td style="padding-left: 10px" align=left><asp:HyperLink ID="ltlTitle" Title="View detail." runat="server"></asp:HyperLink></td>
                            <td style="width:350px; padding-left:5px; text-align:center;"><%#Eval("Nganhnghe")%></td>
                            <td style="padding-left: 5px; width:50px;"><asp:Literal ID="ltlCreated" runat="server"></asp:Literal></td>
                            <td align="center"><asp:LinkButton ID="lbtSend" runat="server"></asp:LinkButton></td>
